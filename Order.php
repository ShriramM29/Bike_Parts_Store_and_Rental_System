...
<table width="80%" bgcolor="#FFFFFF">
  ...
  <tr>
    <td colspan="2" style="font-size:26px;color:#3300CC; font-weight:bold" align="center"> Order Details </td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
if(isset($_POST['Submit']))
{
	...
	$result=mysql_query("insert into Order1 value('$oid','$dt','$uname','$fid','$type','$name','$qty','$price','$uqty','$tprice','$cardno','Pending')");
