	    ...
	    <center>
	      <form id="form1" name="form1" method="post" action="">
	        <table width="300px" style=" color:#000000; font-size:14px">
	          ...
	          <tr>
                <td colspan="2" style="font-size:28px;color:#3300CC; font-weight:bold" align="center"> View Spare Order Details </td>
	            </tr>
	          <tr>
...
if(isset($_POST['Submit']))
{
	...
	$result =mysql_query("Select * from SpareOrder where Status='$Category'");
